      ...
      <div class="resume-outer">
        <div class="info">
          <div class="base-info">
            ...
            <div class="info-line">
              <span><i class="iconfont icon-smartphone-line" />17625809601</span>
              <a
                href="mailto:wiixdede@gmail.com"
                style="margin-right: 12px"
              ><i class="iconfont icon-mail-line" />wiixdede@gmail.com</a>
            </div>
            <div class="info-line">
              <a
        ...
        <div>转正之后除了页面开发，开始涉及到框架的修改，比如动态权限变化、三方登录。同时也针对某些页面进行性能优化，UI细节优化，组件代码重构、尽量减少项目中es5的写法、拒绝<pre>Vue</pre>项目中使用<pre>JQuery</pre>。</div>
        <strong class="project-title">家庭服务机器人、水表识别（大学期间）</strong>
        <div>使用 <pre>ROS</pre> 系统操作机器人（<pre>C ++</pre>），过程中涉及<pre>SLAM</pre>、建图、导航，使用深度学习进行物品识别、从而提供家庭服务，顺带使用深度学习做了水表识别项目。</div>
        <h2 class="title">
          专业技能
        </h2>
